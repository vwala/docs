...
* Added email template customization. This means you can brand/customise the emails that we send to your referrers on your behalf. The template system includes live variable substitution for smarter templates. This new feature is found in `customise`.
