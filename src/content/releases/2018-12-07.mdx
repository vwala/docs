...
* You can now omit commission payments to influencers who have not yet satisfied a minimum order amount or count (you can set this via `customise > commission payment rules`)
...
* Our in-app chat, support and help docs can now be hidden from your influencers (via the `customise` page).
...
* Improved the readability of the `customise` page and simplified labels where required.
