...
* We've added new stats! We now track influencer referrals and payable commission. Learn more about [payable commission](https://help.vwa.la/merchant/paying-commission/#what-are-payment-rules) - how it is calculated and how payable commission rules can be customised. 
