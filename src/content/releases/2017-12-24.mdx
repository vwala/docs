...
* You can now configure our anti-fraud system, by enabling / disabling self-orders (`customise`)
* You can also now enable/disable email notifications for specific events (`customise`)
