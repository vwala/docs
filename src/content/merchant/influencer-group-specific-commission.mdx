...
You can reward influencers differently by segmenting your influencers into groups. You can then set group specific commission rules via the `customise page > influencer commission, link & discount code rules` section.
...
- Once you have finished creating groups, you must go to the `customise page > influencer commission, link & discount code rules` section and configure the group's commission rules.
...
### Then go to the `customise page > influencer commission, link & discount code rules` section and configure commission rules

![](../../images/merchant/customise_a_rules.png)

![](../../images/merchant/customise_a_rules_2.png)
