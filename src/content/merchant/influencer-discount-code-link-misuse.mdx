...
You can disable automatic approval of new influencer sign-ups and force influencers to provide their social media accounts. This can be done via `customise > business rules`. This has the added benefit of making your marketing program feel more exclusive.
...
- Create a T&Cs page and add a URL to your T&Cs page to your sign up page (via `customise > signup page`). You can use this guide as a [template](/merchant/adding-a-page-to-your-store).
- Customise your new influencer welcome email template (via the `customise` page)
- Ensure your `customise page > influencer commission, link & discount code rules` section is correctly set up
