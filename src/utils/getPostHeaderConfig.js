...
export const getPostHeaderConfig = ({ pathname }) => {
    ...
    //     postHeaderConfig.title = `Setup Guide Z`
    ...
    if (pathname.match(/^\/influencer\//i)) {
        postHeaderConfig.title = `Influencer help`
        postHeaderConfig.mainLink = `/influencer/getting-started/`
        postHeaderConfig.bgClass = `bg-concepts`
    }
