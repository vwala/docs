...
* The "promotion policy" page and `customise` pages are now merged within a single "customise" page. This means that all settings to customise your marketing program are accessible within a single page.
